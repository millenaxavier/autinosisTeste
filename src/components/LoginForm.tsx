  ...
  return (
    <div className="flex flex-col gap-4 max-w-sm mx-auto">
      ...
      <button
        ...
        disabled={loading}
        className="flex items-center justify-center gap-2 bg-white border border-gray-300 text-gray-700 p-3 rounded-lg hover:bg-gray-50 disabled:opacity-50"
      >
      ...
      <button
        ...
        disabled={loading}
        className="bg-blue-600 text-white p-3 rounded-lg disabled:opacity-50 hover:bg-blue-700"
      >
        {loading ? "Processando..." : "Enviar Link de Login"}
      </button>
